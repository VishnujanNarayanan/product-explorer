...
let Navigation = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('navigation')];
    ...
    var Navigation = _classThis = class {
        constructor() {
            ...
            this.last_scraped_at = (__runInitializers(this, _slug_extraInitializers), __runInitializers(this, _last_scraped_at_initializers, void 0));
            this.categories = (__runInitializers(this, _last_scraped_at_extraInitializers), __runInitializers(this, _categories_initializers, void 0));
    ...
    (() => {
        ...
        _categories_decorators = [(0, typeorm_1.OneToMany)(() => category_entity_1.Category, (category) => category.navigation)];
